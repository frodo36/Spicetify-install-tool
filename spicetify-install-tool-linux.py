...
def start():
    ...
    if user.lower() == "i":
        ...
        if user.lower() == "yes":
            ...
            system("sudo chmod a+wr /usr/share/spotify")
            system("sudo chmod a+wr /usr/share/spotify/Apps -R")
        else:
            print("Invalid input")
            start()
        ...
        system("git clone https://github.com/CharlieS1103/spicetify-marketplace")
        system(f"mv spicetify-marketplace {config_folder}/CustomApps")
        system("spicetify config custom_apps spicetify-marketplace")
